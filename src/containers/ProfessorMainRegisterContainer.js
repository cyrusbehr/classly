...
import ProfessorRegisterContainer from './ProfessorSubContainers/ProfessorRegisterContainer';
import { connect } from 'react-redux';

class ProfessorMainRegisterContainer extends Component {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(ProfessorMainRegisterContainer);
